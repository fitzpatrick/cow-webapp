...
public class Header extends HLayout {
	...
	public Header(String page_type, PageWidget p) {
		...
		ToolStripMenuButton manageMenu = new ToolStripMenuButton("Manage", manage);
	...
	protected ClickHandler generateClickHandler(String button) {
		if(button.equals(PageWidget.PAGE_TASKS)) {
			return new ClickHandler() {
				public void onClick(ClickEvent event) {
					PageManager.getInstance().setPage(new Tasks());
				}
			};
			...
			return new ClickHandler() {
				public void onClick(ClickEvent event) {
					PageManager.getInstance().setPage(new Admin());
				}
			};
		}
		return null;
		...
		if(menu.equals("new_workflow")) {
			return new com.smartgwt.client.widgets.menu.events.ClickHandler() {
				public void onClick(MenuItemClickEvent event) {
					PageManager.getInstance().setPage(new EditWorkflow(""));
				}
			};
		} else if(menu.equals(PageWidget.PAGE_CREATENEWTASK)) {
			return new com.smartgwt.client.widgets.menu.events.ClickHandler() {
				public void onClick(MenuItemClickEvent event) {
					PageManager.getInstance().setPage(new CreateNewTask());
				}
			};
		} else if(menu.equals("load_workflow")) {
			return new com.smartgwt.client.widgets.menu.events.ClickHandler() {
				public void onClick(MenuItemClickEvent event) {
					PageManager.getInstance().setPage(new EditWorkflow(true));
				}
			};
			...
			return new com.smartgwt.client.widgets.menu.events.ClickHandler() {
				public void onClick(MenuItemClickEvent event) {
					PageManager.getInstance().setPage(new ManageWorkflows());
				}
			};
